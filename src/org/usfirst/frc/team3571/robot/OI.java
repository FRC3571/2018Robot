...
public class OI {
	...
	public OI() {
		...
		operator.Buttons.A.runCommand(new OpenCloseCommand(true), CommandState.WhenPressed);
		operator.Buttons.B.runCommand(new OpenCloseCommand(false), CommandState.WhenPressed);
