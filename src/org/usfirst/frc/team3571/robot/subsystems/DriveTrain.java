...
import org.usfirst.frc.team3571.robot.commands.TankDriveWithJoystick;
...
public class DriveTrain extends Subsystem {
	private SpeedController m_leftMotor
			= new SpeedControllerGroup(new Spark(0), new Spark(1), new Spark(2));
	private SpeedController m_rightMotor
			= new SpeedControllerGroup(new Spark(3), new Spark(4), new Spark(5));
